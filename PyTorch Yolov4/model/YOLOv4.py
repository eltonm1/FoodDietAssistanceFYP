...
from model.Neck.Neck import SpatialPyramidPoolingPANet
...
class YOLOV4(nn.Module):
    ...
    def setIsValidating(self, isValidating):
        self.isValidating = isValidating
        self.large13YOLOHead.isValidating = isValidating
        self.mid26YOLOHead.isValidating = isValidating
        self.small52YOLOHead.isValidating = isValidating
    ...
    def forward(self, x):
        ...
        return (p, p_d) if not self.isValidating else torch.cat(p_d, dim=0)
