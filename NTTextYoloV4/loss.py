...
class YoloV4Loss(nn.Module):
    ...
    def __cal_loss_per_layer(self, p, p_d, label, bboxes, stride):
        ...
        p_d_xywh = p_d[..., :4] # => (bs, 52/26/13, 52/26/13, 3, 4)
            
        label_xywh = label[..., :4] # => (bs, 52/26/13, 52/26/13, 3, 4)
        ...
        # loss giou
        giou = CIOU_xywh_torch(p_d_xywh, label_xywh).unsqueeze(-1) # => (bs, 52/26/13, 52/26/13, 3, 1)
